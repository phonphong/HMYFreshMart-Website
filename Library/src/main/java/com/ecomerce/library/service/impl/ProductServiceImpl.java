...
import com.ecomerce.library.repository.ProductRepository;
import com.ecomerce.library.service.ProductService;
import com.ecomerce.library.utils.ImageUpload;
    ...
    public Product update(MultipartFile imageProduct, ProductDto productDto) {
        try {
            ...
            if (productUpdate != null) {
                ...
                // Handle the case where the product to be updated is not found
                return null;
            }
        } catch (Exception e) {
            e.printStackTrace();
